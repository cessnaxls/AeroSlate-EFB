...
export function FuelPage({ ofp, flight }: { ofp: AnyRecord | null; flight: FlightSummary }) {
  ...
  return <div className="fuel-page">
    <section className="card fuel-overview"><header><div><Fuel size={18} /><h3>OFP fuel plan</h3></div><span className="pill blue">OFP SOURCE</span></header><div className="card-body">
