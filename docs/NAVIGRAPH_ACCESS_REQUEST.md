...
- Standalone behavior: when no virtual-environment link is active, AeroSlate opens Navigraph's official Charts web application in a reusable window and does not call the third-party Charts API
